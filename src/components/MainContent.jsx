          ...
          <div className="row">
            <div className="card full-width-card">
              <div className="card-content" onClick={() => navigate("/quiz")}>
                <h2>Quiz</h2>
                <p>
                  Kiedy jeszcze nie wiesz, jaka rasa jest dla Ciebie odpowiednia
                  i potrzebujesz pomocy
                </p>
              </div>
              <img src={Quiz} alt="Karta 3" className="card-image-right-big" />
            </div>
          </div>
          <div className="row">
            <div
              className="card half-width-card"
            ...
            >
              ...
              <img src={Blog} alt="Karta 4" className="card-image-centered" />
            </div>
            <div
              className="card half-width-card"
            ...
            >
              ...
              <img src={Porady} alt="Karta 5" className="card-image-centered" />
            </div>
          </div>
        </div>
